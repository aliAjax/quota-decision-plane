...
func NewFixedWindow() *FixedWindow { return &FixedWindow{states: map[string]fixedState{}} }
...
func NewSlidingWindow() *SlidingWindow { return &SlidingWindow{states: map[string][]event{}} }
...
func NewTokenBucket() *TokenBucket { return &TokenBucket{states: map[string]tokenState{}} }
